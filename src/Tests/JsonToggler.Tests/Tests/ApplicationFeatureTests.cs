...
{
    [TestClass]
    public class ApplicationFeatureTests : BaseTestHelper
    {

        private static string _application = "TestApp";

        private static string _all = "All";

        private static string _wrongApp = "TestAppXYZ";
        ...
        [TestMethod]
        public void Feature_LOCALIsEnabledWrongApp_ReturnsFalse()
        {
            var jsonSettings = GetJsonSettings(EnvironmentEnum.LOCAL, _wrongApp);
        ...
        [TestMethod]
        public void Feature_DEVIsEnabledAll_ReturnsFalse()
        {
            var jsonSettings = GetJsonSettings(EnvironmentEnum.DEV, _all);
        ...
        {
            var jsonSettings = GetJsonSettings(EnvironmentEnum.PROD, _application);
        ...
        {
            var jsonSettings = GetJsonSettings(EnvironmentEnum.LOCAL, PlatformEnum.Android, _application);
        ...
        {
            var jsonSettings = GetJsonSettings(EnvironmentEnum.PROD, PlatformEnum.iOS, _application);
        ...
        {
            var jsonSettings = GetJsonSettings(EnvironmentEnum.PROD, PlatformEnum.WinPhone, _application);
        ...
        {
            var jsonSettings = GetJsonSettings(EnvironmentEnum.LOCAL, PlatformEnum.Desktop, _application);
        ...
        {
            var jsonSettings = GetJsonSettings(EnvironmentEnum.DEV, PlatformEnum.Web, _application);
        ...
        {
            var jsonSettings = GetJsonSettings(EnvironmentEnum.QAS, PlatformEnum.Web, _application);
        ...
        {
            var jsonSettings = GetJsonSettings(EnvironmentEnum.STAGE, PlatformEnum.Android, _application);
        ...
        {
            var jsonSettings = GetJsonSettings(EnvironmentEnum.DEV, PlatformEnum.iOS, _application);
        ...
        {
            var jsonSettings = GetJsonSettings(EnvironmentEnum.QAS, PlatformEnum.iOS, _application);
        ...
        {
            var jsonSettings = GetJsonSettings(EnvironmentEnum.STAGE, PlatformEnum.iOS, _application);
        ...
        {
            var jsonSettings = GetJsonSettings(EnvironmentEnum.QAS, PlatformEnum.WinPhone, _application);
        ...
        {
            var jsonSettings = GetJsonSettings(EnvironmentEnum.STAGE, PlatformEnum.WinPhone, _application);
        ...
        {
            var jsonSettings = GetJsonSettings(EnvironmentEnum.DEV, PlatformEnum.Desktop, _application);
        ...
        {
            var jsonSettings = GetJsonSettings(EnvironmentEnum.STAGE, PlatformEnum.Desktop, _application);
